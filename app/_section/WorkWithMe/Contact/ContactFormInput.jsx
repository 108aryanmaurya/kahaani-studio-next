          ...
          >
            ...
            <div className="flex">
              <input
                ...
                name="user_name"
                placeholder="NAME"
                className="w-full h-12 2xl:text-xl px-4 bg-transparent outline-none text-white border border-solid border-gray-400  transition duration-300 ease-in-out  hover:text-white"
                required
              />
            </div>
            <input
            ...
            <textarea
              ...
              name="message"
              cols={4}
              className="w-full h-32 2xl:text-xl p-4 bg-transparent outline-none text-white border border-solid border-gray-400  transition duration-300 ease-in-out  hover:text-white"
              required
            ></textarea>
