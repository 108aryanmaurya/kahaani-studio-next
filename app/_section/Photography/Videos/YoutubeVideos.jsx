...
export default function YoutubeVideos({ videos }) {
  return (
    <>
      ...
      <div className="mt-10 block w-full columns-3 break-inside-avoid gap-10 gap-y-10 px-10 max-lg:columns-2 max-md:columns-2 max-md:px-0">
        {videos?.map((video) => (
          <div key={video.id} className="w-full py-4 aspect-video ">
            <YoutubeLazyLoad
