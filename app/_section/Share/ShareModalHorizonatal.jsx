      ...
      <div className="my-5 flex w-full cursor-pointer flex-row items-center justify-start transition-all duration-500 ease-out max-md:flex-col">
        ...
        <div className="flex flex-wrap gap-3 font-CooperHewitt text-white max-sm:gap-0">
          ...
          <FacebookShareButton url={currentUrl}>
            <a
              className="ease mb-1 mr-1 inline-flex items-center rounded-full border-2 border-[#316FF6] bg-[#316FF6] px-5 py-3 text-white transition duration-200 hover:border-[#316FF6] hover:bg-[#316ff6cc]"
              target="_blank"
              rel="noopener"
          ...
          <TwitterShareButton url={currentUrl}>
            <a
              className="ease mb-1 mr-1 inline-flex items-center rounded-full border-2 border-blue-600 bg-[#1da1f2] px-5 py-3 text-white transition duration-200 hover:border-blue-500 hover:bg-blue-400"
              target="_blank"
              rel="noopener"
              aria-label="Share on Twitter"
            >
          ...
          <WhatsappShareButton url={currentUrl}>
            <a
              className="ease mb-1 mr-1 inline-flex items-center rounded-full border-2 border-green-600 bg-green-500 px-5 py-3 text-white transition duration-200 hover:border-green-700 hover:bg-green-400"
              target="_blank"
              rel="noopener"
