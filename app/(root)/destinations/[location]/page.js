...
import BlogsContentDestination from "@/app/_section/Destinations/BlogsContentDestination";
...
import { fetchblogsbylocation } from "@/lib/actions/blogs.actions";
...
export default async function page({ params: { location } }) {
  ...
  const blogs = await fetchblogsbylocation(location);
